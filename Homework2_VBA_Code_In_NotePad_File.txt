Sub Stock_Analysis()
'===============================================================================================
' EASY CHALLENGE --> CREATING LOOP THRU EACH YEAR OF STOCK
'===============================================================================================
    ...
    For Each ws in Worksheets
        ...
        For i = 2 To lastrow
            ...
            If ws.Cells(i, 1).Value <> ws.Cells(i + 1, 1).Value Then
                ...
                End If
'===============================================================================================
' MODERATE CHALLEGE --> YEARLY CHANGE OF STOCK AND PERCENTAGE CHANGE
'===============================================================================================
        ...
        Next i
'==================================================================================================
' THE HARD CHALLENGE --> GREATEST INCREASE AND GREATEST DECREASE AND GREATEST TOTAL VOLUME
'==================================================================================================
        ...
        'Last row assignment to count the number of rows in the summary table
